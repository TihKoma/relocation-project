...
import { ChoiceNeighborhoodMapFacade } from './ChoiceNeighborhoodMapFacade'

export class ChoiceNeighborhoodMapProvider extends MapProvider<ChoiceNeighborhoodMapFacade> {
  createMapFacade(
    mapAdapter: MapAdapter,
    mapEvents: MapEvents,
    apolloClient: ApolloClient<object>,
  ): ChoiceNeighborhoodMapFacade {
    ...
    this._mapFacade = new ChoiceNeighborhoodMapFacade(
      drawer,
      mapEvents,
      mapServerApi,
      mapPosition,
