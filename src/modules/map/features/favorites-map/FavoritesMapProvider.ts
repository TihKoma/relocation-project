...
import { FavoritesMapFacade } from './FavoritesMapFacade'

export class FavoritesMapProvider extends MapProvider<FavoritesMapFacade> {
  createMapFacade(
    ...
    this._mapFacade = new FavoritesMapFacade(
      mapDrawer,
      mapEvents,
      mapServerApi,
      mapPosition,
